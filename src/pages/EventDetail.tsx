              ...
              {Object.entries(timeLeft).map(([unit, value]) => (
                <div key={unit} className="text-center">
                  <div className="bg-white rounded-lg p-3 shadow-sm border border-blue-200">
                    ...
                    <div className="text-xs text-blue-800 uppercase">{unit}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        return (
          <div className="bg-green-50 border border-green-200 rounded-xl p-6">
            <h3 className="text-lg font-semibold text-green-900 mb-4 flex items-center">
              ...
              Certificate Minting Open
            </h3>
            <p className="text-green-800 mb-4">
              🎉 You are whitelisted for this event! You can now mint your participation certificate.
            </p>
            <Link
              to={`/mint/${event.id}`}
              className="w-full bg-green-600 hover:bg-green-700 text-white py-3 px-4 rounded-lg font-semibold transition-all flex items-center justify-center"
            >
              Mint Certificate
            </Link>
          </div>
